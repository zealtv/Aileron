...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 179.0, 316.0, 152.0, 91.0 ],
					"text" : "DATA-FORMATTER exists inside DATA-SELECTOR and enables scaling and bounds managment for input data source",
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 16.0, 249.5, 161.0, 244.0 ],
					"varname" : "aileron.sub.data-formatter",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 366.0, 679.5, 143.0, 37.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 356.0, 444.5, 153.0, 91.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 356.0, 259.5, 153.0, 64.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 356.0, 101.0, 153.0, 78.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 263.0, 563.0, 139.0, 51.0 ],
					"text" : "MAP maps scaled data to Ableton Live parameters ",
					"textcolor" : [ 0.772549019607843, 0.388235294117647, 0.298039215686275, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 271.0, 200.0, 150.0, 51.0 ],
					"text" : "DATA-SELECTOR selects data-stream from HUB",
					"textcolor" : [ 0.772549019607843, 0.388235294117647, 0.298039215686275, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 289.0, 39.0, 150.0, 51.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 16.0, 542.0, 242.0, 178.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 511.0, 77.5, 325.0, 171.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 16.0, 215.0, 250.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 511.0, 630.5, 292.0, 171.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 511.0, 444.5, 411.0, 174.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 511.0, 259.5, 360.0, 169.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 16.0, 6.0, 267.0, 173.0 ],
					"viewvisibility" : 1
				}
		...
		"parameters" : 		{
			...
			"obj-8::obj-40" : [ "out-lo[10]", "out-lo", 0 ],
			...
			"obj-8::obj-3" : [ "bounds-mode[10]", "bounds", 0 ],
			...
			"obj-8::obj-8" : [ "post-add[10]", "post-add", 0 ],
			...
			"obj-8::obj-7" : [ "pre-add[10]", "pre-add", 0 ],
			...
			"obj-8::obj-9" : [ "multiply[10]", "multiply", 0 ],
			...
			"obj-8::obj-39" : [ "out-hi[10]", "out-hi", 0 ],
...
,
				"obj-8::obj-3" : 				{
					"parameter_longname" : "bounds-mode[10]"
				}
,
				"obj-7::obj-6::obj-26" : 				{
